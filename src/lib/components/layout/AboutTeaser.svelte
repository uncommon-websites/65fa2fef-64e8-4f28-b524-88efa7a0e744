...
<script lang="ts">
	...
	const teamMember: TeamMember = {
		name: "Hunter Leath",
		role: "Founder & CEO",
		image: "/generated/image-a-confident-tech-founder-in-a-san-franci.webp"
	};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`"I’ve worked with hundreds of teams—and they all ran into the same bottlenecks with active data. Archil is the system I always wished I had."`}
			/>
